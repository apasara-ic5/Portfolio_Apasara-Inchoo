...
function dropdownLevelHum(levelSelectorHum) {
    ...
    if(truncatedText == "All"){
      dropdown.innerText = "ทั้งหมด";
    }else if(truncatedText == "Raw"){
      dropdown.innerText = "ดิบ";
    }else if(truncatedText == "Ripe"){
      dropdown.innerText = "สุก";
    }else if(truncatedText == "Very Ripe"){
  ...
  note.innerHTML =`*หมายเหตุ ค่าความชื้นที่ต่ำที่สุด : `+minValueHum.toFixed(2)+`  ค่าความชื้นที่สูงที่สุด : `+maxValueHum.toFixed(2)+` `;
  }
